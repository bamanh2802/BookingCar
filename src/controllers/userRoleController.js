...
const updateRolePermissions = catchAsync(async (req, res) => {
  ...
  const updatedRole = await userRoleService.updateRolePermissions(
    req.params.roleId,
    permissions
  );
  res.status(StatusCodes.OK).json(
...
const updateRoleInherits = catchAsync(async (req, res) => {
  ...
  const updatedRole = await userRoleService.updateRoleInherits(
    req.params.roleId,
    inherits
  );
  res.status(StatusCodes.OK).json(
...
const getRolePermissions = catchAsync(async (req, res) => {
  const rolePermissions = await userRoleService.getRolePermissions(
    req.params.roleId
  );
  res.status(StatusCodes.OK).json(
    ApiResponse.success({
